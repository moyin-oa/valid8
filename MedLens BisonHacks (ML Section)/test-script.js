...
import { analyzeMedicalDocument, processDocument, extractText } from './medlens-ai.js';
...
async function testFullPipeline() {
  ...
  const imagePath = './sample-discharge.png';
  try {
    readFileSync(imagePath); // check file exists
  } catch {
    console.log(`Skipping — no image found at ${imagePath}`);
    console.log('To test OCR, save a screenshot of a medical document as sample-discharge.png');
    return;
  }
