...
export default function LandingPage() {
    ...
    const startProcessing = (state = {}) => {
        navigate('/processing', {
            state: {
                inputType: state.inputType || 'document',
    ...
    const handleCameraCapture = () => {
        ...
        startProcessing({
            inputType: 'camera',
            rawText: 'Camera image captured. OCR preview mode is active in frontend. Paste text for best live backend results.',
        });
    };
    ...
    const handleFileChange = (e) => {
        ...
        startProcessing({
            inputType: 'upload',
            fileName: file.name,
            rawText: `Uploaded file: ${file.name}. OCR parsing from file upload is not wired on frontend yet.`,
        });
    };
